			...
			while (true)
			 {
				...
				strcpy(logo[7], "=>Eng: Amr");
				strcpy(logo[8], "=========>Eng: Fares");
				strcpy(logo[9], "=>Eng: Mark");
				...
				printBox(28, 9, 30, 15); // box for the menu

				printBox(14, 24 , 24 , 4) ; //player1 score box

				printBox(46, 24 , 24 , 4) ; //player2 score box
...
//				int check = 0;
			...
			while (true)
			 {
				...
				puts(guess);
                gotoXY(47, 25);
                if (!(count&1)) // take player 1 and player 2 name as input
                cout<<"Player 1 : " <<p1_count;
                else
                cout<<"Player 2 : " <<p2_count;
	...
	//function to print programer on the screen
		void programer() {
    SetConsoleTextAttribute(H_Console, 12);  // Set text color to red
    clearScreen();

    char about[23][78]; // Increased size to accommodate all lines

    // Populate the about array with the necessary strings
    strcpy(about[0], "                                :: HANGMAN ::                                ");
    strcpy(about[1], "                                                                             ");
    strcpy(about[2], "                  But if you're not able to guess the word and               ");
    strcpy(about[3], "             		   	                                                       ");
    strcpy(about[4], "                     lives finish then you lose the round!                   ");
    strcpy(about[5], "                                                                             ");
    strcpy(about[6], "                      First, Player 1 must enter word to be                  ");
    strcpy(about[7], "                       	 				                                   ");
    strcpy(about[8], "                          guessed, along with the hint                       ");
    strcpy(about[9], "                                                                             ");
    strcpy(about[10], "                      Player 2 will try to guess the word                    ");
    strcpy(about[11], "                                                                             ");
    strcpy(about[12], "                               *******************                           ");
    strcpy(about[13], "                                                                             ");
    strcpy(about[14], "                    Project was made by computer science students :          ");
    strcpy(about[15], "                                                                             ");
    strcpy(about[16], "                        programers:                                          ");
    strcpy(about[17], "                                                                             ");
    strcpy(about[18], "                                ==> Fares Mohammed                           ");
    strcpy(about[19], "                                ==> Amr Musad                                ");
    strcpy(about[20], "                                ==> Mark Zaki                                ");
    strcpy(about[21], "                         Instructor: Eng:- Amani Shreif                      ");
    strcpy(about[22], "                                                                             ");

    // Print the about array
    for (int i = 0; i < 23; i++) {  // Updated loop to print all 23 strings
        gotoXY(1, 5 + i);
        puts(about[i]);
    }

    gotoXY(0, 29); // Move the cursor to the bottom
    getch(); // Wait for user input
    hangmanGame(); // Call the game function
}
